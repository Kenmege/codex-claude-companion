...
7. Verify the package landed at https://www.npmjs.com/package/codex-plugin-cc. For a stable release, `npm view codex-plugin-cc version` must return the tagged version. For a prerelease, stable must remain unchanged and `npm view codex-plugin-cc@next version` must return the tagged version.
